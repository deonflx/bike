...
# ===========================================================
# GeoDjango / GDAL configuration for Windows (OSGeo4W)
# After installing OSGeo4W, the DLLs live in C:\OSGeo4W\bin
# Adjust the version numbers below if they differ on your system
# ===========================================================
if os.name == 'nt':
    OSGEO4W = r'C:\OSGeo4W'
    GDAL_LIBRARY_PATH = os.path.join(OSGEO4W, 'bin', 'gdal313.dll')
    GEOS_LIBRARY_PATH = os.path.join(OSGEO4W, 'bin', 'geos_c.dll')
    PROJ_LIBRARY_PATH = os.path.join(OSGEO4W, 'bin', 'proj_9.dll')
    ...
    # Required on Python 3.8+ for Windows to find DLL dependencies
